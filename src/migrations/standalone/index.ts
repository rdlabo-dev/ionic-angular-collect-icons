...
export const runStandaloneMigration = async ({
  ...
  // Repair the initializer generated by older releases on every run. This is
  // deliberately independent of --initialize so upgrading the package and
  // running an existing prebuild script is enough to remove allIcons from the
